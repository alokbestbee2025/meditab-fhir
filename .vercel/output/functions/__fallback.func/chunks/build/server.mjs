import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { inject as inject$1, computed, toValue, Fragment, ref, toRaw, getCurrentInstance as getCurrentInstance$1, warn, capitalize, watch, onScopeDispose, toRef, readonly, shallowRef, camelize, isVNode, Comment, useId, provide, defineComponent as defineComponent$1, unref, hasInjectionContext, reactive, watchEffect, createVNode, mergeProps, createElementVNode, effectScope, normalizeClass, defineAsyncComponent, h, shallowReactive, Suspense, normalizeStyle, createApp, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, isRef, isShallow, isReactive, getCurrentScope, withCtx, toRefs, nextTick, useSSRContext } from 'vue';
import { j as hasProtocol, o as isScriptProtocol, l as joinURL, w as withQuery, c as createError$1, s as sanitizeStatusCode, q as getContext, $ as $fetch, v as baseURL, x as createHooks, y as executeAsync, z as toRouteMatcher, A as createRouter$1, B as defu } from '../_/nitro.mjs';
...
const vuetify_icons_hWgvV3ijVuMkm5G1ceR8znyespd65VtgomkCUK9HsnY = /* @__PURE__ */ defineNuxtPlugin({
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-D18mX4-N.mjs')
  },
  {
    name: "build-apps",
    path: "/build-apps",
    component: () => import('./build-apps-BJfZelos.mjs')
  },
  {
    name: "documentation",
    path: "/documentation",
    component: () => import('./documentation-C6Et7UHn.mjs')
  },
  {
    name: "docs-slug",
    path: "/docs/:slug(.*)*",
    component: () => import('./_...slug_-CeAvOxgm.mjs')
  },
  {
    name: "registration-page",
    path: "/registration-page",
    component: () => import('./registration-page-BYkqWHE3.mjs')
  }
];
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-CRFqaAy_.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-V7QyU4Eh.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-5kSjsZhf.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-BNmZo7u4.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-DQWmvZmn.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-DkRsvYmg.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-DD3IS3Hj.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-C__9O45s.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-DDtjuDnV.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-EmeqtCRg.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-CRf_AEry.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-CHisFgjL.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-COxYuMD3.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-AfW4pLCH.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-C3MDilBK.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-CKtOyBqg.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-DiP6Ogim.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-_ZnL1TLI.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-yks6bfEA.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-CbQkNOlz.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-DabGtr4W.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-DXw6ynRu.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-CISqanzj.mjs').then((r) => r["default"] || r.default || r));
...
function vuetifyConfiguration() {
  const options = { "theme": { "defaultTheme": "light", "themes": { "light": { "colors": { "primary": "#1e3c61", "secondary": "#e46c0d", "third": "#e76b09", "fourth": "#ffa600", "fifth": "#226498", "gray": "#f7f7f7", "text": "#212121", "thead": "#f3f3f3", "heading": "#1e3c61", "navItem": "#d1e1e5", "headerItem": "#ffffff", "leftSidebar": "#f7f7f7", "theading": "#f7f7f7", "tborder": "#cccccc" } } } }, "ssr": true };
  return options;
}
...
const plugins = [
  vuetify_icons_hWgvV3ijVuMkm5G1ceR8znyespd65VtgomkCUK9HsnY,
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Ap7OVYmK.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BNPuVA0R.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BZxzcymg.mjs'));
...
export { useLocale as $, parseColor as A, getForeground as B, getCurrentInstanceName as C, useTheme as D, useIcon as E, flattenFragments as F, keyCodes as G, isObject as H, IconValue as I, useProxiedModel as J, getCurrentInstance as K, deepEqual as L, wrapInArray as M, consoleWarn as N, findChildrenWithProvide as O, consoleError as P, onlyDefinedProps as Q, defineComponent as R, hasEvent as S, deprecate as T, EventProp as U, isPrimitive as V, getPropertyFromItem as W, omit as X, focusChild as Y, clamp as Z, _export_sfc as _, useNuxtApp as a, callEvent as a0, useToggleScope as a1, filterInputAttrs as a2, matchesSelector as a3, makeDisplayProps as a4, useDisplay as a5, useResizeObserver as a6, useGoTo as a7, focusableChildren as a8, CircularBuffer as a9, templateRef as aa, isClickInsideElement as ab, getNextElement as ac, debounce as ad, camelizeProps as ae, ensureValidVNode as af, checkPrintable as ag, defer as ah, useLayoutItem as ai, makeLayoutItemProps as aj, useLayout as ak, VApp as al, useRuntimeConfig as b, nuxtLinkDefaults as c, useRequestEvent as d, entry$1 as default, convertToUnit as e, useRtl as f, genericComponent as g, useRender as h, breakpoints as i, provideTheme as j, provideDefaults as k, makeThemeProps as l, makeComponentProps as m, navigateTo as n, pick as o, propsFactory as p, useRoute as q, resolveRouteObject as r, asyncDataDefaults as s, tryUseNuxtApp as t, useRouter as u, createError as v, includes as w, destructComputed as x, isCssColor as y, isParsableColor as z };
