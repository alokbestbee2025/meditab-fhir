import { withCtx, createVNode, ref, mergeProps, createTextVNode, createBlock, openBlock, withModifiers, createElementVNode, normalizeStyle, normalizeClass, computed, shallowRef, toRef, watch, Fragment, watchEffect, withDirectives, vModelText, useId, inject, provide, onScopeDispose, nextTick, vShow, toDisplayString, Transition, Teleport, reactive, toValue, toRaw, readonly, useSSRContext } from 'vue';
import { ssrRenderComponent } from 'vue/server-renderer';
import { useRouter } from 'vue-router';
import { B as BaseCard } from './BaseCard-CAKi_NiO.mjs';
import { _ as _export_sfc, g as genericComponent, p as propsFactory, h as useRender, $ as useLocale, J as useProxiedModel, M as wrapInArray, L as deepEqual, ae as camelizeProps, af as ensureValidVNode, a2 as filterInputAttrs, m as makeComponentProps, X as omit, ag as checkPrintable, a3 as matchesSelector, f as useRtl, ab as isClickInsideElement, K as getCurrentInstance, a1 as useToggleScope, e as convertToUnit, j as provideTheme, Z as clamp, a0 as callEvent, I as IconValue, Y as focusChild, ac as getNextElement, a8 as focusableChildren, a5 as useDisplay, a6 as useResizeObserver, ad as debounce, W as getPropertyFromItem, l as makeThemeProps, U as EventProp, aa as templateRef, x as destructComputed, a9 as CircularBuffer, P as consoleError, k as provideDefaults, a4 as makeDisplayProps, a7 as useGoTo } from './server.mjs';
import { V as VSheet } from './VSheet-BzJMmtal.mjs';
import { V as VProgressCircular, a as VBtn } from './VBtn-Dip3530s.mjs';
import { V as VTextField, c as createForm, f as forwardRefs, a as useForm, b as useFocus, d as VInput, e as VField, g as VCounter, h as useAutofocus, i as makeFormProps, j as makeVTextFieldProps, k as makeVFieldProps, l as makeVInputProps, u as useLazy, n as VLabel, o as animate, p as acceleratedEasing, s as standardEasing, q as deceleratedEasing, m as makeLazyProps, r as getTargetBox, t as nullifyTransforms, B as Box, v as getElementBox, w as getOverflow } from './VTextField-BClI15J3.mjs';
import { n as useItems, h as VIcon, V as VList, a as VListItem, o as VDivider, p as VListSubheader, q as VAvatar, g as VDefaultsProvider, I as Intersect, r as makeTransitionProps, R as Ripple, s as useBorder, t as useDensity, e as useElevation, f as useRounded, v as useSize, c as useGroupItem, w as useLink, x as useVariant, y as genOverlays, z as VExpandXTransition, A as makeItemsProps, d as useBackgroundColor, B as useRouter$1, M as MaybeTransition, C as makeVariantProps, D as makeSizeProps, E as makeRouterProps, j as makeRoundedProps, k as makeGroupItemProps, l as makeElevationProps, F as makeDensityProps, G as makeBorderProps, H as useTextColor, J as parseAnchor, K as flipSide, L as flipAlign, N as flipCorner, O as getAxis, m as makeGroupProps, u as useGroup, P as VFadeTransition } from './loader-2bNA6OgU.mjs';
import { u as useScopeId, a as useDelay, m as makeDelayProps } from './scopeId-vwGQsgNJ.mjs';
import { V as VContainer, a as VRow, b as VCol, u as useDimension, c as makeDimensionProps, m as makeTagProps } from './VRow-zyUvS5jf.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const productItems = [
      { title: "Product Looking For*", value: "" },
      // shows as placeholder, selectable but fails validation
    ...
    const notPlaceholderRule = (value) => value !== "" || "Please select a product.";
    const requiredRule = (value) => !!value || "This field is required.";
    const emailRule = (value) => /.+@.+\..+/.test(value) || "Enter a valid email.";
    const phoneRule = (value) => /^[0-9\-\+\s]{6,15}$/.test(value) || "Enter a valid phone number.";
    async function handleSubmit() {
      var _a;
      isLoading.value = true;
      let formData = {};
      if (!((_a = formRef.value) == null ? void 0 : _a.validate())) {
        return;
      }
      formData = {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(VSheet, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(BaseCard, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (isLoading.value) {
                    _push3(`<div class="d-flex justify-center align-center" data-v-1b2f095b${_scopeId2}>`);
                    ...
                    _push3(`<div data-v-1b2f095b${_scopeId2}><h4 class="mb-4" data-v-1b2f095b${_scopeId2}>Please Fil Your Details!</h4>`);
                    _push3(ssrRenderComponent(VForm, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="form-wrapper" data-v-1b2f095b${_scopeId3}>`);
                          ...
                          _push4(`</div><div class="form-wrapper" data-v-1b2f095b${_scopeId3}>`);
                          _push4(ssrRenderComponent(VTextField, {
                          ...
                          _push4(ssrRenderComponent(VSelect, {
                            ...
                            "onUpdate:modelValue": ($event) => product.value = $event,
                            items: productItems,
                            "item-title": "title",
                            "item-value": "value",
                  ...
                  return [
                    isLoading.value ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("h4", { class: "mb-4" }, "Please Fil Your Details!"),
                      createVNode(VForm, {
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Forms/RegistrationForm.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const RegistrationForm = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-1b2f095b"]]);
const _sfc_main = {
  __name: "registration-page",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VCol, { cols: "12" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(RegistrationForm, null, null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode(RegistrationForm)
                        ];
                      }
                    }),
                    _: 1
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/registration-page.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=registration-page-2Y0M50Rd.mjs.map
