...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "70184d53-52b9-4f67-b475-91daac40dd62",
  ...
  "emailPort": "587",
  "emailUser": "alok@bestbee.ai",
  "emailPass": "jkdgutogiogmbwuv",
  "emailFrom": "alok@bestbee.ai",
  "emailTo": "alok@bestbee.ai",
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "C:/Users/aloks/Desktop/meditab-fhir/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "ipx": {
...
const _rtvZSw = eventHandler(async (event) => {
...
const _Tum6X6 = eventHandler(async (event) => {
...
const _591yg1 = lazyEventHandler(() => {
...
const _lazy_QeioA9 = () => import('../routes/api/contact-mail.mjs');
const _lazy_L_IgM7 = () => import('../routes/api/docs.mjs');
const _lazy_oyhAix = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/contact-mail', handler: _lazy_QeioA9, lazy: true, middleware: false, method: undefined },
  { route: '/api/docs', handler: _lazy_L_IgM7, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_oyhAix, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _rtvZSw, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _Tum6X6, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _591yg1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_oyhAix, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, createRouter$1 as A, defu as B, pascalCase as C, kebabCase as D, destr as E, withLeadingSlash as F, withTrailingSlash as G, parseURL as H, encodeParam as I, encodePath as J, withoutTrailingSlash as K, useRuntimeConfig as a, buildAssetsURL as b, createError$1 as c, defineEventHandler as d, eventHandler as e, defineRenderHandler as f, publicAssetsURL as g, getQuery as h, getRouteRules as i, hasProtocol as j, relative as k, joinURL as l, getResponseStatusText as m, getResponseStatus as n, isScriptProtocol as o, parseQuery as p, getContext as q, readBody as r, sanitizeStatusCode as s, toNodeListener as t, useNitroApp as u, baseURL as v, withQuery as w, createHooks as x, executeAsync as y, toRouteMatcher as z };
